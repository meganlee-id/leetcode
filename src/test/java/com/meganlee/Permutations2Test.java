...
public class Permutations2Test {
    ...
    public void testCase1() {
        Assert.assertEquals(calculate(a1), "[[1, 1, 2, 3], [1, 1, 3, 2], [1, 2, 1, 3], [1, 2, 3, 1], [1, 3, 2, 1], [1, 3, 1, 2], [2, 1, 1, 3], [2, 1, 3, 1], [2, 3, 1, 1], [3, 1, 2, 1], [3, 1, 1, 2], [3, 2, 1, 1]]");
    }

    @Test
    public void testCase2() {
        Assert.assertEquals(calculate(a2), "[[1, 2, 2, 2], [2, 1, 2, 2], [2, 2, 1, 2], [2, 2, 2, 1]]");
    }
}